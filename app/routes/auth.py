...
from app.core.security_helpers import get_refresh_token_cookie_params, get_logout_cookie_params
...
def logout(
    ...
    # Clear cookie: use set_cookie with max_age=0 and empty value.
    # delete_cookie() does not accept httponly/samesite/secure kwargs reliably
    # across Starlette versions, so this is the safe cross-browser approach.
    logout_params = get_logout_cookie_params()
    response.set_cookie(**logout_params)
